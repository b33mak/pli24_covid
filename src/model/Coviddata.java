...
@NamedQueries({
    ...
    @NamedQuery(name = "Coviddata.findByCountryNameAndKind", query = "SELECT c FROM Coviddata c WHERE c.country.name = :country_name AND c.datakind = :datakind")
})
public class Coviddata implements Serializable {
    ...
    public String toString() {
        return "gui.Coviddata[ coviddata=" + coviddata + " Country: " + country.getName() + " Kind: " + datakind + " Date: " + new java.sql.Date(trndate.getTime()).toString() + " QTY: " + qty + " PQTY: " + proodqty + " ]";
    }
